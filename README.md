# full_stack_resources

收集整理全栈开发学习资料，涵盖前端、Python、数据库、运维、AB测试等方向。

本项目采用 **GitHub + HuggingFace 双端存储** 方案：
- **大文件 (>50MB)**: 自动分流并托管至 [HuggingFace Datasets](https://huggingface.co/datasets/hfhfn/full_stack_resources)
- **小文件与代码**: 保存在 GitHub 仓库
- **动态导航**: 通过 [GitHub Pages](https://hfhfn.github.io/full_stack_resources) 提供统一的搜索与下载界面

---

## 目录

- `01-AB测试从0到1` - AB测试相关资料
- `02-前端` - 前端开发学习资料
- `03-python语言` - Python 语言学习资料
- `04-数据库` - 数据库相关资料
- `05-开发` - 通用开发资料
- `06-运维` - 运维相关资料
