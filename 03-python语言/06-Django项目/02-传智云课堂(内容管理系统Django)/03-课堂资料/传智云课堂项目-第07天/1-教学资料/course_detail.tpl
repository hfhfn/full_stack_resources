...
<div class="article-banner">
    ...
    <div class="banner-info">
        <div class="banner-left">
            ...
            <p class="info">
                <a href="http://ucenter.czstudy.com/#/learning/{{courseBase.id}}/0"  target="_blank" v-if="learnstatus == 1" v-cloak>马上学习</a>
		...
		低级
                {% elif courseBase.grade == '200002' %}
		中级
                    {% elif courseBase.grade == '200003' %}
		高级
		{% endif %}
                </span>
		...
		自由学习
                {% elif courseBase.studymodel == '201002' %}
		任务式学习
		{% endif %}
                </span>
            </p>
	    ...
	    {% if coursePic.pic %}
	     <p><img src="http://img.czstudy.com/{{coursePic.pic}}" alt="" width="270" height="156"> </p>
	     {% else %}
