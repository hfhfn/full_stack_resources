...
<div><br/>
  ...
  <div id="uploader" class="wu-example">
    <el-button  type="primary" id="picker" class="cz-button-border" round>选择文件</el-button>
    <el-button  type="primary" class="cz-button-border" round @click="upload">开始上传</el-button>
  </div>
  <!--用来存放文件信息-->
...
//      var uploadFile;
      WebUploader.Uploader.register({
          ...
          beforeSendFile:function(file) {
            ...
            // 计算文件的唯一标识，用于断点续传
            this.uploader.md5File(file, 0, 100*1024*1024)
              .then(function(val) {
